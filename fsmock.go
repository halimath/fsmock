// Package fsmock provides a testing facility to generate mock values that
// satisfy fs.FS and friends. The package supports developers writing readable,
// easy to maintain tests that work closely with the filesystem without relying
// to local or temporary filesystem operations.
package fsmock
